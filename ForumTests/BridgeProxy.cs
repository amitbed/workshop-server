...
namespace ForumTests
{
    class BridgeProxy : BridgeProject
    {
        ...
        public Thread createThread(string title, string subForum, string forum)
        {
            if (this.real != null)
            {
                return real.createThread(title, subForum, forum);
            }
            else return null;
        }
        ...
        public bool isThreadExistsInSubForum(string title, string sf, string f)
        {
            if (this.real != null)
            {
                return real.isThreadExistsInSubForum(title, sf, f);
            }
            else return false;
        }
